...
.DEFAULT_GOAL := help
.PHONY: greet blog calculator reader move help 
project := greet calculator blog reader move 
...
reader: $@ ## Generate Pbs and build for reader
blog: $@ ## Generate Pbs and build for blog
move: $@ ## Generate Pbs and build for move
...
clean: clean_greet clean_calculator clean_blog clean_reader clean_move## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_reader: ## Clean generated files for reader
	${RM_F_CMD} reader/${PROTO_DIR}/*.pb.go

clean_move: ## Clean generated files for move
	${RM_F_CMD} move/${PROTO_DIR}/*.pb.go
